...
void MeshViewer::draw_current_mesh() {
    // cv::Mat img = cv::imread("/home/anonym/Schreibtisch/PhD/code/Sparse Template based Reconstruction/data/ColonoscopyDataset/rgb/FWD_00000.png");
   
    mDrawer->addTextureImage(img);
...
void MeshViewer::run() {
    ...
    t <<3,4,5;
    tri.push_back(t);
    mDrawer->addTriangles(tri);
    mDrawer->addVertices(vert);
