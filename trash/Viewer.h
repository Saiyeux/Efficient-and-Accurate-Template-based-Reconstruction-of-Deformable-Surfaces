...
class MeshViewer {
    public:
        MeshViewer();
        MeshViewer(database *db, cv::Mat img, std::vector<Eigen::Vector3d> vertices, std::vector<Eigen::Vector3i> triangles, const YAML::Node &config);
    ...
    private:
        ...
        MeshDrawer *mDrawer = new MeshDrawer();
        // menu panel
